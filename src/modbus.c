...
const unsigned short wCRCTable[] = { 0X0000, 0XC0C1, 0XC181, 0X0140, 0XC301,
...
unsigned char *make_discrete_inputs_request(unsigned char dev_addr,
		unsigned short reg_addr, unsigned short reg_value) {
	return make_request(dev_addr, reg_addr, reg_value, READ_DISCRETE_INPUTS);
}

unsigned char *make_read_coils_request(unsigned char dev_addr,
		unsigned short reg_addr, unsigned short reg_value) {
